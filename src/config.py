...
class Config:
    ...
    def arguments_parser(cls) -> ArgumentParser:
        ...
        parser.add_argument("-if", "--inputfile", dest="inputfile", required=False)
        return parser
    ...
    def set_defaults(self):
        ...
        # Added defaults for code embedding extraction
        self.MODEL_LOAD_PATH = (
            "processing_tools/code2vec/models/java14_model/saved_model_iter8.release"
        )
